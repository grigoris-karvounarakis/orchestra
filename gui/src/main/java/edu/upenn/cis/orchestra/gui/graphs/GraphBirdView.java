 ...
 */
public class GraphBirdView extends JPanel implements
	...
	public BasicGraph getCurrentGraph() {
		return (BasicGraph) ((_currentGraph != null) ? _currentGraph.get() : null);
	}
	...
	public class NavigatorPane extends JScrollPane implements MouseListener,
		...
		public void paint(Graphics g) {
			...
			if (scrollPane != null && graph != null) {
				...
				g.fillRect(_currentViewport.x - deltaX, _currentViewport.y - deltaY,
						_currentViewport.width, _currentViewport.height);

				super.paint(g);
				g.setColor(Color.RED);
				g.drawRect(_currentViewport.x-deltaX, _currentViewport.y- deltaY,
						_currentViewport.width, _currentViewport.height);
			}
		}
