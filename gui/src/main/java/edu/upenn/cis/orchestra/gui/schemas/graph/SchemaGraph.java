...
public class SchemaGraph extends BasicGraph implements ActionListener 
{
	...
	public void applyLayout ()
	{
		...
		orgLayout.setOptimizeBorderLine(facade.getEdges().size()==0);
		orgLayout.setEdgeLengthCostFactor(0.0005);


		applyLayout(facade, orgLayout, true, new Point(0,0), (facade.getEdges().size()!=0));
	}
	...
	class AddAttributeBox extends JDialog {
		...
		public  AddAttributeBox(Relation relAdd) {
			...
			if(blnLatestRevision)
			{
				...
				JLabel labelAttributeType = new JLabel("Attribute Type");
