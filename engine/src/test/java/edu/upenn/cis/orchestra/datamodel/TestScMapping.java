...
public class TestScMapping extends TestCase {
			...
			DatabaseException
	{
		...
		PeerBean peer2B = peer.toBean();
		peer2B.setId("peer2");
		peer2B.setDescription("desc2");
		peer2B.setAddress("add2");
		_system.addPeer(new Peer(peer2B));
	...
	public void testBeanConversions ()
	{
		...
		OrchestraSystemBean systBean = syst.toBean();
		
		PeerBean pB = systBean.getPeers().get(0);
		if (!pB.getId().equals("peer1"))
			pB = systBean.getPeers().get(1);
		ScMappingBean mappBean = pB.getMappings().get(0);
		
		assertTrue(mappBean.getId().equals("mapp1"));
		assertTrue(mappBean.getDescription().equals("mapp1"));
		assertTrue(mappBean.isMaterialized());
		assertTrue(mappBean.getTrustRank()==2);
		assertTrue(mappBean.getHead().size()==2);

		ScMappingAtomBean atomB = mappBean.getHead().get(0); 
		assertTrue(atomB.getPeerId().equals("peer1"));
		assertTrue(atomB.getSchemaId().equals("schema1"));
		assertTrue(atomB.getRelationId().equals("name1"));
		assertTrue(atomB.getValues().get(0).getType().equals("S"));
		assertTrue(atomB.getValues().get(0).getId().equals("f1"));
		assertTrue(atomB.getValues().get(1).getType().equals("V"));
		assertTrue(atomB.getValues().get(1).getId().equals("X"));
		assertTrue(atomB.getValues().get(2).getType().equals("V"));
		assertTrue(atomB.getValues().get(2).getId().equals("Y"));
		assertTrue(atomB.getValues().get(3).getType().equals("C"));
		assertTrue(atomB.getValues().get(3).getId().equals("CST1"));

		atomB = mappBean.getHead().get(1);
		assertTrue(atomB.getPeerId().equals("peer1"));
		assertTrue(atomB.getSchemaId().equals("schema1"));
		assertTrue(atomB.getRelationId().equals("name2"));
		assertTrue(atomB.getValues().get(0).getType().equals("V"));
		assertTrue(atomB.getValues().get(0).getId().equals("Y"));
		assertTrue(atomB.getValues().get(1).getType().equals("V"));
		assertTrue(atomB.getValues().get(1).getId().equals("X"));
		assertTrue(atomB.getValues().get(2).getType().equals("V"));
		assertTrue(atomB.getValues().get(2).getId().equals("Z"));
		assertTrue(atomB.getValues().get(3).getType().equals("C"));
		assertTrue(atomB.getValues().get(3).getId().equals("CST2"));

		atomB = mappBean.getBody().get(0);
		assertTrue(atomB.getPeerId().equals("peer1"));
		assertTrue(atomB.getSchemaId().equals("schema2"));
		assertTrue(atomB.getRelationId().equals("name1"));
		assertTrue(atomB.getValues().get(0).getType().equals("V"));
		assertTrue(atomB.getValues().get(0).getId().equals("X"));
		assertTrue(atomB.getValues().get(1).getType().equals("V"));
		assertTrue(atomB.getValues().get(1).getId().equals("Y"));
		assertTrue(atomB.getValues().get(2).getType().equals("C"));
		assertTrue(atomB.getValues().get(2).getId().equals("CST1"));
		assertTrue(atomB.getValues().get(3).getType().equals("C"));
		assertTrue(atomB.getValues().get(3).getId().equals("CST2"));		

		atomB = mappBean.getBody().get(1);
		assertTrue(atomB.getPeerId().equals("peer2"));
		assertTrue(atomB.getSchemaId().equals("schema2"));
		assertTrue(atomB.getRelationId().equals("name2"));
		assertTrue(atomB.getValues().get(0).getType().equals("V"));
		assertTrue(atomB.getValues().get(0).getId().equals("X"));
		assertTrue(atomB.getValues().get(1).getType().equals("V"));
		assertTrue(atomB.getValues().get(1).getId().equals("Z"));
		assertTrue(atomB.getValues().get(2).getType().equals("C"));
		assertTrue(atomB.getValues().get(2).getId().equals("CST1"));
		assertTrue(atomB.getValues().get(3).getType().equals("C"));
		assertTrue(atomB.getValues().get(3).getId().equals("CST2"));	
		
		assertTrue(mappBean.getBody().size()==2);
