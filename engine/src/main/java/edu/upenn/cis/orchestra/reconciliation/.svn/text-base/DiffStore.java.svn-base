...
//	Schema schema;
	...
	protected static class StoreEntry {
		...
		static StoreEntry fromBytes(SchemaIDBinding s, byte[] bytes, int offset, int length) throws SSException {
	...
	DiffStore(AbstractPeerID pid, SchemaIDBinding schema, int lastTid) {
		/*
