...
public class DoubleType extends Type {
	...
	static final int bytesPerDouble = Double.SIZE / Byte.SIZE;
	...
	public edu.upenn.cis.orchestra.optimization.Type getOptimizerType() {
		return edu.upenn.cis.orchestra.optimization.DoubleType.create(this.isNullable(), this.isLabeledNullable());
	}
