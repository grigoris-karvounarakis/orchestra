...
//	private Schema s;
	private SchemaIDBinding s;
	private byte[] bytes;
	private int offset;
	private int length;
	
	public ByteBufferReader(SchemaIDBinding  s, byte[] bytes, int offset, int length) {
		this.s = s;
		this.bytes = bytes;
		this.offset = offset;
		this.length = length;
	}
	public ByteBufferReader(SchemaIDBinding  s, byte[] bytes) {
		this(s, bytes, 0, bytes.length);
	}
	public ByteBufferReader(SchemaIDBinding  s) {
		this.s = s;
		this.bytes = null;
		this.offset = 0;
		this.length = 0;
	...
	public Tuple getTupleFromBytes(SchemaIDBinding sch, byte[] bytes, int offset, int length) {
