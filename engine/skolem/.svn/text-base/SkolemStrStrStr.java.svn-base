...
public class SkolemStrStrStr extends COM.ibm.db2.app.UDF {
	private static int FIRST_SKOLEM = -214748366;
	public static String CONNECTION = "skolemStrStrStr";
...
/* This code is automatically generated */
	...
	public static int skolemStrStrStr(String skolemName, String StrVal0, String StrVal1, String StrVal2) throws IOException {
		try {
			int skVal = skolem("StrStrStr", skolemName, StrVal0, StrVal1, StrVal2);
