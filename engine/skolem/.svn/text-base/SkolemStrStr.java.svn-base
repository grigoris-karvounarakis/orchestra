...
public class SkolemStrStr extends COM.ibm.db2.app.UDF {
	private static int FIRST_SKOLEM = -107374184;
	public static String CONNECTION = "skolemStrStr";
...
/* This code is automatically generated */
	...
	public static int skolemStrStr(String skolemName, String StrVal0, String StrVal1) throws IOException {
		try {
			int skVal = skolem("StrStr", skolemName, StrVal0, StrVal1);
