...
public class SkolemStr extends COM.ibm.db2.app.UDF {
	private static int FIRST_SKOLEM = -2;
	public static String CONNECTION = "skolemStr";
...
/* This code is automatically generated */
	...
	public static int skolemStr(String skolemName, String StrVal0) throws IOException {
		try {
			int skVal = skolem("Str", skolemName, StrVal0);
