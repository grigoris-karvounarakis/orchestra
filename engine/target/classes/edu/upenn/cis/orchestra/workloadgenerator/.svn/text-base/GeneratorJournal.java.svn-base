...
public class GeneratorJournal {
	 ...
	 * 	{integers=1, inout=true, oracle=0, skip=0, cutoff=1024, password=4sa7ya, addBypasses=1, deletions=1, 
	 *     username=db2admin, relsize=15, tukwila=0, fanout=2, olivier=1, schemas=3, dbalias=BIOTBS, insertions=2, 
	 ...
	 * 	  &lt;/iteration&gt;
	 * 	  &lt;peer name=&quot;P0&quot; address=&quot;grw561-3.cis.upenn.edu-7777&quot;&gt;
	 * 	  &lt;/peer&gt;
