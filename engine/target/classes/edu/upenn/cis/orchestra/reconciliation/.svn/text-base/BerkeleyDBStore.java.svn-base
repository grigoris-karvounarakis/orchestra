...
public class BerkeleyDBStore extends DiffStore {
	...
	public static class Factory implements StateStore.Factory {
		...
		public StateStore getStateStore(AbstractPeerID pid, SchemaIDBinding s, int lastTid) throws BDBStateStoreException {
			try {
	...
	Database updatesDb;
	public BerkeleyDBStore(Environment e, String stateName, String updatesName, AbstractPeerID pid, SchemaIDBinding schema, int lastTid) throws DatabaseException {
