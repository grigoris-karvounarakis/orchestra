...
public abstract class UpdateStore implements TransactionDecisions {
	public interface Factory {
		public UpdateStore getUpdateStore(AbstractPeerID pid, SchemaIDBinding sch, Schema s, TrustConditions tc) throws UpdateStore.USException;
		public void serialize(Document doc, Element update);
		public void resetStore(Schema s) throws USException;
		USDump dumpUpdateStore(SchemaIDBinding binding, Schema schema) throws USException;
