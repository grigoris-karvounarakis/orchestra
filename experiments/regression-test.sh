...
PARAMS="-Xms768m -Xmx768m -classpath ${cp} edu.upenn.cis.orchestra.Console "

DB2="db2cmd /c /w /i db2 -tf "

# Run old version of code

java $PARAMS -batch cimr-old

# Run copy script

mv ../engine/copyScript .
$DB2 copyScript

# Run new version of code

java $PARAMS -batch drop-cimr-new
